...
// orphan behind. An exception thrown by write_body is one such failure: it
// propagates to the caller with the temporary already removed.
// Returns true only when the destination was replaced.
