...
// VNM Plot Library - Series Renderer
// Renders data series as lines, dots, or areas with LOD support.
...
private:
    ...
    std::map<shader_set_t, std::shared_ptr<QOpenGLShaderProgram>> m_shaders;
    ...
    std::shared_ptr<QOpenGLShaderProgram> get_or_load_shader(
