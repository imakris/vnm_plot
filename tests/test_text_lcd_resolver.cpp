...
bool test_default_null_probes_return_none()
{
    ...
    TEST_ASSERT(
        plot::resolve_text_lcd_subpixel_order_from_probes(
            plot::text_lcd_subpixel_order_t::AUTO,
            probes) == plot::text_lcd_subpixel_order_t::NONE,
...
bool test_auto_prefers_qt_probe_and_skips_windows()
{
    ...
    probes.qt_probe = [] {
        return plot::text_lcd_subpixel_order_t::RGB;
    };
    probes.windows_probe = [&windows_called] {
        windows_called = true;
        return plot::text_lcd_subpixel_order_t::BGR;
    };

    TEST_ASSERT(
        plot::resolve_text_lcd_subpixel_order_from_probes(
            plot::text_lcd_subpixel_order_t::AUTO,
            probes) == plot::text_lcd_subpixel_order_t::RGB,
...
bool test_auto_falls_back_to_windows()
{
    plot::text_lcd_resolver_probes_t probes;
    probes.qt_probe = [] {
        return plot::text_lcd_subpixel_order_t::NONE;
    };
    ...
    TEST_ASSERT(
        plot::resolve_text_lcd_subpixel_order_from_probes(
            plot::text_lcd_subpixel_order_t::AUTO,
            probes) == plot::text_lcd_subpixel_order_t::BGR,
...
bool test_explicit_orders_skip_probes()
{
    ...
    const plot::text_lcd_subpixel_order_t explicit_orders[] = {
        plot::text_lcd_subpixel_order_t::NONE,
        plot::text_lcd_subpixel_order_t::RGB,
        plot::text_lcd_subpixel_order_t::BGR,
        plot::text_lcd_subpixel_order_t::VRGB,
        plot::text_lcd_subpixel_order_t::VBGR,
    };

    for (const plot::text_lcd_subpixel_order_t order : explicit_orders) {
        TEST_ASSERT(
            plot::resolve_text_lcd_subpixel_order_from_probes(order, probes) == order,
...
bool test_explicit_orders_for_null_window_are_deterministic()
{
    ...
    for (const plot::text_lcd_subpixel_order_t order : explicit_orders) {
        TEST_ASSERT(
            plot::resolve_text_lcd_subpixel_order_for_window(order, nullptr) == order,
...
bool test_probe_auto_or_invalid_results_fail_closed()
{
    plot::text_lcd_resolver_probes_t probes;
    probes.qt_probe = [] {
        return plot::text_lcd_subpixel_order_t::AUTO;
    };
    probes.windows_probe = [] {
        return plot::text_lcd_subpixel_order_t::BGR;
    };
    TEST_ASSERT(
        plot::resolve_text_lcd_subpixel_order_from_probes(
            plot::text_lcd_subpixel_order_t::AUTO,
            probes) == plot::text_lcd_subpixel_order_t::BGR,
        "Qt AUTO probe result should be treated as NONE before Windows fallback");
    ...
    TEST_ASSERT(
        plot::resolve_text_lcd_subpixel_order_from_probes(
            plot::text_lcd_subpixel_order_t::AUTO,
            probes) == plot::text_lcd_subpixel_order_t::NONE,
        "Windows AUTO probe result should fail closed");

    const auto invalid_order = static_cast<plot::text_lcd_subpixel_order_t>(255);
    probes.windows_probe = [invalid_order] {
